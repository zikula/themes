...
<link rel="stylesheet" href="{$stylepath}/layout.css" type="text/css" media="screen,projection"  />
<script src="{$themepath}/javascript/maxheight.js" type="text/javascript"></script>