...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;padding-right : 10px;" class="credits">
            {gt text="design by"}:&nbsp;<a href="http://andreasviklund.com/" title="{gt text="Link to"} andreasviklund.com"><strong>Andreas&nbsp;Viklund</strong></a>&nbsp;|&nbsp;
            {gt text="Template sponsored by"}&nbsp;<a href="http://www.roses-nationwide.com/" title="{gt text="Link to"} roses-nationwide.com">{gt text="Send Flowers"}</a>&nbsp;|&nbsp;
