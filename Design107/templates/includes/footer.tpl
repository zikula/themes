...
<div id="footer">
    <p>
        ...
        <span style="float : left; font-size : .7em; letter-spacing : .07em; margin-bottom : 5px; margin-top : 10px; padding-bottom : 5px; padding-left : 5px; text-align : left; clear:both;">
            {assign var="poweredbyz" value="Powered by Zikula"}
            {gt text='Powered by <a href="http://zikula.org" title="%s">Zikula</a>' tag1=$poweredbyz}&nbsp;|&nbsp;
            {assign var="designbyz" value="Design by dcarter"}
            {gt text='Design by <a href="http://www.dcarter.co.uk/" title="%s">dcarter</a>' tag1=$designbyz}&nbsp;|&nbsp;
