<form id="searchbox" method="post" action="{modurl modname="Search" type="user" func="search"}">
    <div>
        <input id="block_search_q" class="text" type="text" name="q" size="20" maxlength="255" />
