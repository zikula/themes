...
<div id="footer">
    <p>
        ...
        <span style="float : left; font-size : .84em; letter-spacing : .08em; margin-bottom : 5px; margin-top : 5px; padding-bottom : 5px; padding-left : 0px; text-align : left;">
            {assign var="poweredbyz" value="Powered by Zikula"}
            {gt text='Powered by <a href="http://zikula.org" title="%s"><strong>Zikula</strong></a>' tag1=$poweredbyz}&nbsp;|&nbsp;
            {assign var="designbyz" value="Design by Matt Dibb"}
            {gt text='Design by <a href="http://www.mdibb.net" title="%s"><strong>Matt Dibb</strong></a>' tag1=$designbyz}&nbsp;|&nbsp;
