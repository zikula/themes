<div id="footer">
    ...
    <span style="float : left; font-size : .8em; letter-spacing : .07em; margin-bottom : 5px; margin-top : 5px; padding-bottom : 5px; padding-left : 0px; text-align : left; clear:both;">
        {assign var="poweredbyz" value="Powered by Zikula"}
        {gt text='Powered by <a href="http://zikula.org" title="%s">Zikula</a>' tag1=$poweredbyz}&nbsp;|&nbsp;
        {assign var="designbyz" value="Design by contenteddesigns.org"}
        {gt text='Design by <a href="http://contenteddesigns.org/" title="%s">contenteddesigns.org</a>' tag1=$designbyz}&nbsp;|&nbsp;
