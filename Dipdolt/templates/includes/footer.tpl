<div id="footer">
    ...
    {gt text="Design"}:&nbsp;<a href="http://www.darjanpanic.com" title="{gt text="Freelance Graphic Artist"}">Darjan&nbsp;Panic</a>&nbsp;{gt text="and"}&nbsp;<a href="http://www.briangreens.com" title="{gt text="Link to"} briangreens.com">Brian&nbsp;Green</a>
    {* Please leave this if you use our template. Thank you *}
</div>