<div id="page_footer">
    ...
    <div class="right">
        <a href="http://www.zikula.org" title="{gt text="Link to"} Zikula.Org">{gt text="Powered By Zikula"}</a><br />
        {gt text="design"}:&nbsp;<a href="http://DesignsByDarren.com" title="{gt text="Link to"} DesignsByDarren.com"/>Darren Hester</a>&nbsp;|&nbsp;
