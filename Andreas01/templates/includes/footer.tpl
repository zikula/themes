...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;">
            {gt text="design"}:&nbsp;<a href="http://andreasviklund.com/" title="{gt text="Link to"} andreasviklund.com"><strong>Andreas&nbsp;Viklund</strong></a>&nbsp;|&nbsp;
            ...
            <a href="#header" title="{gt text="Back to top"}">^</a><br />
