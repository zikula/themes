...
<div id="footer">
    <p>
        ...
        <span style="float:left;font-size : 8px; text-align : left; padding-left : 0px;">
            {assign var="poweredbyz" value="Powered by Zikula"}
            {gt text='Powered by <a href="http://zikula.org" title="%s">Zikula</a>' tag1=$poweredbyz}&nbsp;|&nbsp;
            {assign var="designbyz" value="Design by Jonas John"}
            {gt text='Design by <a href="http://www.jonasjohn.de/" title="%s">Jonas John</a>' tag1=$designbyz}&nbsp;|&nbsp;
