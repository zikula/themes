<div id="footer">
    <p>
        ...
        <div style="clear:left;float : left; font-size : .8em; letter-spacing : .09em; margin-bottom : 5px; margin-top : 0px; padding-bottom : 5px; padding-left : 35px; text-align : left;">
