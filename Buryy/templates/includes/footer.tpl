<div id="footer">
    <p>
        <span style="float:left;">
            ...
            <a href="{modurl modname='News' type='user' func='view' theme='rss'}" title="{gt text="Subscribe link for our News RSS feed"}">{gt text="RSS"}&nbsp;<img class="icon" src="{$imagepath}/rss.gif" alt="{gt text="RSS Feed icon"}" /></a>
        </span>
