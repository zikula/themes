<div id="footer">
    ...
    <span style="float:right;text-align:right;padding-right:25px;">
        {gt text="Nautica03 V.2+ Theme by"}:&nbsp;<a href="http://takeit2.com" title="{gt text="Link to"} TakeIT2.CoM">TakeIT2</a>&nbsp;|&nbsp;
        {gt text="Design by"}:&nbsp;<a href="http://www.studio7designs.com" title="{gt text="Link to"} studio7designs.com">studio7designs</a>&nbsp;|&nbsp;
