<div id="toptabs">
    ...
    <a class="last toptab {if $module eq 'Users func=logout'} activenavitab {/if}" href="{modurl modname=Users func=logout}" title="{gt text="Logout of Your Account"}">{ gt text="Logout"} </a>
    {else}
    <p>
        ...
        <a class="last toptab {if $module eq 'Users func=loginscreen'} activenavitab {/if}" href="{modurl modname=Users func=loginscreen}" title="{gt text="Log In to Your Account"}">{ gt text="Log In"} </a>
        {/if}
    </p>
</div>
