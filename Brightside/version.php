<?php 
$themeversion['name'] = 'Brightside';
$domain = ZLanguage::getThemeDomain($themeversion['name']);
$themeversion['displayname'] = __('Brightside', $domain);
$themeversion['description'] = __('Brightside Open Designs template', $domain);
...
$themeversion['license'] = 'docs/license.html';
