...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;padding-right:5px;">
            {gt text="design by"}:&nbsp;<a href="http://raygerrard.com/" title="{gt text="Link to"} raygerrard.com"><strong>Raymond Gerrard</strong></a>&nbsp;|&nbsp;
            {gt text="Powered by"}&nbsp;<a href="http://www.zikula.org" title="{gt text="Link to"} zikula.org">Zikula</a>&nbsp;|&nbsp;
