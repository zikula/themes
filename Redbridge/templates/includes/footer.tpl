<div class="footer">
    <p>
        ...
        <br />
        <span>
            {gt text="Design:"}&nbsp;<a href="http://www.free-css-templates.com/" title="{gt text="Free CSS Templates"}">{gt text="David Herreman"}</a>&nbsp;::&nbsp;{gt text="Photo courtesy of and &copy; Free Range Stock,"}&nbsp;<a href="http://www.freerangestock.com/" title="{gt text="Link to" freerangestock.com}">{gt text="www.freerangestock.com"}</a>
        </span>
    </p>
</div>