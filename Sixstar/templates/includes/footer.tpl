...
<div id="footer">
    ...
    <div class="wrapper">
        ...
        <span style="clear:both; float : left; font-size : .75em; letter-spacing : .075em; margin-top : 10px; padding-bottom : 5px; text-align : left;">
        {assign var="poweredbyz" value="Powered by Zikula"}
        {gt text='Powered by <a href="http://zikula.org" title="%s">Zikula</a>' tag1=$poweredbyz}&nbsp;|&nbsp;
        {assign var="designbyz" value="Design by lovely"}
        {gt text='Design by <a href="" title="%s">lovely</a>' tag1=$designbyz}&nbsp;|&nbsp;
        {gt text="Valid"}:&nbsp;
