...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;">
            ...
            {gt text="design"}:&nbsp;<a href="http://www.sixshootermedia.com" title="{gt text="Link to the website of Six Shooter Media"}"><strong>{gt text="Six Shooter Media"}</strong></a>&nbsp;|&nbsp;{gt text="Valid"}:&nbsp;<a href="http://jigsaw.w3.org/css-validator/check/referer" title="{gt text="Validate the CSS of this web page"}"><strong>{gt text="CSS"}</strong></a>&nbsp;/&nbsp;
