<div id="footer">
        ...
        <div style="float : left; font-size : .7em; letter-spacing : .07em; margin-bottom : 0px; margin-top : 0px; padding-bottom : 5px; padding-left : 5px; text-align : left; clear: both;">
            {assign var="poweredbyz" value="Powered by Zikula"}
            {gt text='Powered by <a href="http://zikula.org" title="%s">Zikula</a>' tag1=$poweredbyz}&nbsp;|&nbsp;
            {assign var="designbyz" value="Design by Ben Goldman"}
            {gt text='Design by <a href="http://realalibi.com/" title="%s">Ben Goldman</a>' tag1=$designbyz}&nbsp;|&nbsp;
