...
<div id="footer">
    <p>
        <span style="float:left;text-align : left;padding-left:15px;">
            &copy;&nbsp;2003-{'Y'|date}&nbsp;<a href="{homepage}" title="{sitename}&nbsp;{gt text="Home Page"}"><strong>{sitename}</strong></a>&nbsp;|&nbsp;
        ...
        <span style="float:right;text-align:right;padding-right:15px;">
            {gt text="design by"}:&nbsp;<a href="http://jmstudio.nl" title="{gt text="Link to jmstudio.nl"}">JMstudio.nl&nbsp;{gt text="Webdesign"}</a>&nbsp;|&nbsp;
