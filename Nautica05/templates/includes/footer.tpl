...
<div id="footer">
    ...
    <div id="bg" class="width">
        ...
        <ul>
            ...
            <li><a href="{modurl modname='News' type='user' func='view' theme='rss'}" title="{gt text="Subscribe link for our News RSS feed"}">{gt text="RSS FEED"}</a></li>
            <li><a href="http://www.studio7designs.com" title="{gt text="Link to"} studio7designs.com">Studio7Designs</a></li>
            <li>{gt text="Valid"}&nbsp;<a href="http://jigsaw.w3.org/css-validator/check/referer" title="{gt text="Validate the CSS of this web page"}"><strong>{gt text="CSS"}</strong></a></li>
