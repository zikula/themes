...
<div id="page"> 
  <div id="header"> 
    ...
    <ul id="primarylink"> 
      ...
      <li><a href="<!--[pnmodurl modname=pnForum]-->">Forum</a></li> 
      <li><a href="<!--[pnmodurl modname=xSitemap]-->">Sitemap</a></li> 
    </ul> 
  </div> 
  <hr />
  <div id="content" class="widecolumn"> 
	<ul class="navigation">
		...
		<!--[if $modname neq '']-->
			...
			<!--[else]-->
				<a title="<!--[$modinfo.description]-->" href="<!--[pnmodurl modname=$modname]-->"><!--[$modinfo.displayname]--></a>
			<!--[/if]-->
			</li>
		<!--[/if]-->
	</ul> 
