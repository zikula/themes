...
<div id="credits" style="overflow:auto;">
    <p>
        ...
        <span style="float : left; font-size : .70em; letter-spacing : .075em; margin-bottom : 5px; margin-top : 10px; padding-bottom : 5px; padding-left : 5px; text-align : left;clear:both;">
            ...
            {gt text='Design by <a href="http://www.mitchinson.net/" title="%s">Denise Mitchinson</a>' tag1=$designbyz}&nbsp;|&nbsp;
