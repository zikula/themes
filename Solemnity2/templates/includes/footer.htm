...
<div id="footer">
    <p>
        <span style="float:left;">
            &copy;&nbsp;2006-{'Y'|date}&nbsp;<a href="{homepage}" title="{sitename}&nbsp;{gt text="Home Page"}"><strong>{sitename}</strong></a>&nbsp;|&nbsp;<br />
        ...
        <span style="float:right;text-align:right;">
            {gt text="design by"}:&nbsp;<a href="http://www.sixshootermedia.com" title="{gt text="Link to the website of Six Shooter Media"}"><strong>{gt text="Six Shooter Media"}</strong></a>&nbsp;|&nbsp;
            <a href="#content" title="{gt text="Jump to the main content on this page"}">Content</a><br />
