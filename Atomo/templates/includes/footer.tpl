...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;">
            {gt text="design by"}:&nbsp;<a href="http://www.freecsstemplates.org/" title="{gt text="Link to the website of Free CSS Templates"}"><strong>{gt text="Free CSS Templates"}</strong></a>&nbsp;|&nbsp;
