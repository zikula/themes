...
<div id="footer" style="overflow:auto; padding-top : 5px;">
    <p>
        ...
        <div style="float : left; font-size : .75em; letter-spacing : .08em; margin-bottom : 5px; margin-top : 10px; padding-bottom : 0px; padding-left : 10px; text-align : left;clear:both;">
