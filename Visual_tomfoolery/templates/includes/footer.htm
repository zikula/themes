...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;">
            {gt text="design by"}:&nbsp;<a href="http://www.openwebdesign.org/userinfo.phtml?user=coll23" title="{gt text="Link to the website of"} Coll23"><strong>Coll23</strong></a>&nbsp;|&nbsp;
            <a href="http://www.oswd.org" title="{gt text="Link to the website of"} OSWD">OSWD</a>&nbsp;|&nbsp;
