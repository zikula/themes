<div id="footer">
    <div id="footer-content">
        ...
        <div style="float : left; font-size : .7em; letter-spacing : .07em; margin-bottom : 5px; margin-top : 0px; padding-bottom : 5px; padding-left : 10px; text-align : left; clear:both;">
