<div id="footer">
    <span style="float:left;text-align : left;padding-left:5px;">
        ...
        <a href="{modurl modname='News' type='user' func='view' theme='rss'}" title="{gt text="Subscribe link for our News RSS feed"}">{gt text="RSS FEED"}&nbsp;<img class="icon" src="{$imagepath}/rss.gif" alt="{gt text="RSS Feed icon"}" /></a>
    </span>
    <span style="float:right;text-align:right;padding-right:5px;">
        {gt text="DESIGN BY"}&nbsp;<a href="http://www.jdavidmacor.com" title="{gt text="Link to"} jdavidmacor.com">SUPER&nbsp;J&nbsp;MAN</a>&nbsp;|&nbsp;
