<div id="footer">
    <p class="padding">
        ...
        <span style="float:right;text-align:right;padding-right:5px;">
            {gt text="Powered by"}&nbsp;<a href="http://www.zikula.org"  title="{gt text="Link to the website of"} Zikula.org">{gt text="Zikula"}</a>&nbsp;|&nbsp;
            {gt text="Design:"}&nbsp;<a href="http://www.free-css-templates.com/" title="{gt text="Link to the website of Free CSS Templates"}">David Herreman</a>&nbsp;|&nbsp;
