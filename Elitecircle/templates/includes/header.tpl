<div id="header-wrap">
    <div id="header-content">
        ...
        <div id="header-links">
            <p>
            <a href="{homepage}" title="{gt text="Go to the home page of %s" tag1=$modvars.ZConfig.sitename comment="%s is the sitename"}">{gt text="Home"}</a>
                <a href="{homepage}" title="{gt text="Go to the home page of"} {$modvars.ZConfig.sitename}"></a>&nbsp;|&nbsp;
        ...
        {* Menu Tabs *}
        <ul>
            <li {if $pagetype eq 'home'} class="current" {/if}><a href="{homepage}" title="{gt text="Go to the home page of %s" tag1=$modvars.ZConfig.sitename comment="%s is the sitename"}">{gt text="Home"}</a></li>
