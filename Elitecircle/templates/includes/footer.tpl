<div id="footer-wrap">
    <div id="footer-content">
        ...
        <div class="col2 float-right">
            <p>
                &copy;&nbsp;2006-{'Y'|date}&nbsp;<strong><a href="{homepage}" title="{sitename} {gt text="Home Page"}">{sitename}</a></strong><br />
            </p>
            <ul>
...
<span id="footer-design">
    {gt text="design by"}:&nbsp;<a href="http://www.styleshout.com" title="{gt text="Link to"} styleshout.com"><strong>{gt text="styleshout"}</strong></a>&nbsp;&nbsp;::&nbsp;&nbsp;
