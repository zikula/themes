...
<div id="footer">
    <div id="footercontent">
        ...
        <span style="float:right;text-align:right;">
            {gt text="Web template (Plain 2.0) designed by"}:&nbsp;<a href="http://www.sixshootermedia.com" title="{gt text="Link to the website of Six Shooter Media"}"><strong>{gt text="James Koster"}</strong></a>&nbsp;|&nbsp;
