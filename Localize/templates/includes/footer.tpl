<div id="footer">
    ...
    {gt text="design"}:&nbsp;<a href="http://www.openwebdesign.org/userinfo.phtml?user=ad_267" title="{gt text="Link to the website of"} openwebdesign.org/userinfo/ad_267">ad_267</a>&nbsp;/&nbsp;
    {gt text="photo"}:&nbsp;<a href="http://www.sxc.hu/" title="{gt text="Link to"} sxc.hu">Dimiter Tzankov</a>&nbsp;|&nbsp;
