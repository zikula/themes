...
<div id="footer">
    ...
    <span style="float:right;text-align:right;">
        {gt text="design by"}:&nbsp;James Koster&nbsp;{gt text="at"}&nbsp;<a href="http://www.sixshootermedia.com" title="{gt text="Link to the website of Six Shooter Media"}"><strong>{gt text="Six Shooter Media"}</strong></a>&nbsp;|&nbsp;
