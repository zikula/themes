<div id="footer">
    <p>
        ...
        <div class="f-right">
            <a href="http://www.zikula.org" title="{gt text="Link to"} Zikula.Org"><strong>{gt text="Powered By Zikula"}</strong></a><br />
            {gt text="design"}:&nbsp;<a href="http://www.duckwizard.com/" title="{gt text="Link to"} duckwizard.com"><strong>Duckwizard</strong></a>&nbsp;|&nbsp;
