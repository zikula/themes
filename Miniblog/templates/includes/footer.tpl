...
<div id="footer">
    <p>
        ...
        <span style="float:right;text-align:right;">
            <!-- Please leave this line intact -->{gt text="design by"}:&nbsp;{gt text="design by"}:&nbsp;<a href="http://www.sixshootermedia.com" title="{gt text="Link to the website of Six Shooter Media"}"><strong>{gt text="Six Shooter Media"}</strong></a><!-- you can delete below here -->&nbsp;|&nbsp;
