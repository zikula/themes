<div class="footer">
    <span style="float:left;text-align : left;padding-left:40px;">
    ...
    <span style="float:right;text-align:right;padding-right:40px;">
        <a href="http://templates.arcsin.se" title="{gt text="Link to"} templates.arcsin.se">{gt text="Website template"}</a> {gt text="by"} <a href="http://arcsin.se" title="{gt text="Link to"} arcsin.se">{gt text="Arcsin"}</a>&nbsp;|&nbsp;
