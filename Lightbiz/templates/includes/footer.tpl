<div class="footer">
    ...
    <div style="float : left; font-size : .75em; letter-spacing : .075em; margin-bottom : 5px; margin-top : 10px; padding-bottom : 15px; padding-left : 5px; text-align : left; clear:both;">
